...
import { faLinkedin, faTrashAlt } from "@fortawesome/free-solid-svg-icons"
        ...
        <div>
          ...
          <div className="d-flex align-items-center mt-1 mb-1 justify-content-center">
            <a
              ...
              target="_blank"
            >
              <i class="fab fa-linkedin-in fa-2x ml-1 p-1 pr-2 pl-2"></i>
            </a>
            <a href="https://twitter.com/_pablond" target="_blank">
              <i class="fab fa-twitter fa-2x ml-1 p-1 pr-2 pl-2"></i>
            </a>
            <a href="https://github.com/PABlond" target="_blank">
              <i class="fab fa-github fa-2x ml-1 mr-1 p-1 pr-2 pl-2"></i>
            </a>
          </div>
        </div>
      </Row>
